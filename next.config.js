module.exports = {
    env: {
        ...
        "MONGODB_URL": "mongodb+srv://admin:shoban04@cluster1.jwiu3cx.mongodb.net/",
        "ACCESS_TOKEN_SECRET": "@CK{-Rwdf3z`:QZm[Axz!E+u<>ktaeJXSW{2qBcN:Z]%y7e",
        "REFRESH_TOKEN_SECRET": "X5&mNcGq^H8w$uZp@2qA!sJyF6e$Tge",
